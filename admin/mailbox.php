							...
							<div class="box">
								...
								<div class="box-body">
									<div class="mailbox-controls">
										...
										<div class="pull-right">
											<div class="btn-group">
												<button type="button" class="btn btn-primary btn-sm"><i class="ion ion-android-arrow-dropleft"></i></button>
												<button type="button" class="btn btn-primary btn-sm"><i class="ion ion-android-arrow-dropright"></i></button>
											</div>
											<!-- /.btn-group -->
										</div>
										<!-- /.pull-right -->
						...
						<div class="col-xl-4 col-12">
							<div class="box">
										...
										<div class="float-end">
											<div class="btn-group">
												<button type="button" class="btn btn-primary btn-sm" data-bs-toggle="tooltip" data-container="body" title="Delete">
													<i class="ion ion-trash-a"></i></button>
								...
								<div class="box-footer">
									...
									<button type="button" class="btn btn-danger"><i class="ion ion-trash-a"></i></button>
...
<!-- Mirrored from florence-admin-template.multipurposethemes.com/bs5/main-horizontal/mailbox.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 30 Jun 2022 08:05:16 GMT -->
